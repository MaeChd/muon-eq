#!/bin/bash
# ============================================================================
# 2026 Optimizer Comparison - 130M Main Training (Multi-Node)
# ============================================================================
# Usage:
#   NUM_NPUS_PER_JOB=4 bash multi_node_main_130m.sh --nodes 131,132
#
#   NUM_NPUS_PER_JOB=8 \
...
echo "============================================================"
echo " 130M Main Training (Multi-Node)"
...
echo ""
echo "============================================================"
echo " 130M Main Training Complete!"
