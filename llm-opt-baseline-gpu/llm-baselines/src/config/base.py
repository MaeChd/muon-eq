...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--zeropower_mode", default="native", type=str)
    parser.add_argument("--adamuon_eps", default=1e-8, type=float)
    parser.add_argument(
        "--mousse_adjust_lr",
        default="rms_norm",
        type=none_or_str,
    )
    parser.add_argument("--mousse_flatten", default=False, type=bool)
    parser.add_argument("--mousse_shampoo_epsilon", default=1e-5, type=float)
    parser.add_argument("--mousse_shampoo_beta", default=0.95, type=float)
    parser.add_argument("--mousse_shampoo_update_freq", default=10, type=int)
    parser.add_argument("--mousse_shampoo_alpha", default=0.125, type=float)
    parser.add_argument("--mousse_lr_correction", default=True, type=bool)
    parser.add_argument("--mousse_apply_norm", default=True, type=bool)
    parser.add_argument("--mousse_use_lorr", default=0, type=int)
    parser.add_argument("--fismo_ema_beta", default=0.95, type=float)
    parser.add_argument("--fismo_damping", default=1e-4, type=float)
    parser.add_argument("--fismo_matrix_eps", default=1e-6, type=float)
    parser.add_argument(
        "--muonplus_normalize",
        default="col_row",
        choices=["col", "row", "col_row", "row_col"],
    )
    parser.add_argument("--muonplus_eps", default=1e-8, type=float)
    parser.add_argument("--use_muonplus_update", action="store_true")
    ...
    parser.add_argument("--cycle", default=4, type=int)
    parser.add_argument("--block", default=8, type=int)
    parser.add_argument("--r_block", default=8, type=int)
    parser.add_argument("--c_block", default=8, type=int)

    parser.add_argument("--fold_level", default=2, type=int)
    parser.add_argument(
